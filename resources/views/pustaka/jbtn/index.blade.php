                ...
                <div class="panel-body">
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active"><br/>
                      <p>
                        {!! link_to('pustaka/jabatan/create','Tambah Jabatan',['class'=>'btn btn-primary btn-sm']) !!}
                          ...
                          <tbody>
                            @foreach($jabatan as $jb)
                              <tr>
                                ...
                                <td>{{ $jb->jabatan }}</td>
                                <td>
                                  {!! Form::open(array('method'=>'delete','url'=>'pustaka/jabatan/'.$jb->id)) !!}
                                  {!! Form::hidden('_delete','DELETE') !!}
                                  {!! link_to('pustaka/jabatan/'.$jb->id.'/edit','Ubah',['class'=>'btn btn-warning btn-xs']) !!}
